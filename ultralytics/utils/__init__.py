...
def yaml_save(file="plasmodium_data.yaml", data=None, header=""):
    """
    Save YAML data to a file.

    Args:
        file (str, optional): File name. Default is 'plasmodium_data.yaml'.
...
def yaml_load(file="plasmodium_data.yaml", append_filename=False):
    """
