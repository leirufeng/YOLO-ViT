...
class RF100Benchmark:
        ...
        with open(ds_link_txt) as file:
            for line in file:
                try:
                    ...
                    self.ds_cfg_list.append(Path.cwd() / proj_version / "plasmodium_data.yaml")
                except Exception:
                    continue
    ...
    def fix_yaml(path):
        ...
        Examples:
            >>> RF100Benchmark.fix_yaml("path/to/plasmodium_data.yaml")
        """
    ...
    def evaluate(self, yaml_path, val_log_file, eval_log_file, list_ind):
        ...
        Examples:
            ...
            >>> benchmark = RF100Benchmark()
            >>> benchmark.evaluate("path/to/plasmodium_data.yaml", "path/to/val_log.txt", "path/to/eval_log.txt", 0)
        """
        skip_symbols = ["🚀", "⚠️", "💡", "❌"]
