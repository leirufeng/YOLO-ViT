...
class HUBDatasetStats:
    ...
    Args:
        path (str): Path to plasmodium_data.yaml or data.zip (with plasmodium_data.yaml inside data.zip). Default is 'coco8.yaml'.
    ...
    def _unzip(path):
        """Unzip data.zip."""
        if not str(path).endswith(".zip"):  # path is plasmodium_data.yaml
